...
> [Week 10 question bank](10-zipline-aerial-perception-interview.md). Read this as
> the "what would a strong senior/staff answer actually say" companion. Where a topic
> already has a deep-dive in Week 10 Part B, this links rather than repeats.
>
...
6. **Bundle adjustment** — jointly refine all poses + points by minimizing
   reprojection error (see [Week 10 §B1](10-zipline-aerial-perception-interview.md#b1-bundle-adjustment-with-a-pose-prior)).
...
Covered in full in
[Week 10 §B1](10-zipline-aerial-perception-interview.md#b1-bundle-adjustment-with-a-pose-prior).
...
Full deep-dive:
[Week 10 §B2](10-zipline-aerial-perception-interview.md#b2-dsm-vs-dtm--and-why-landing-cares).
Key points:
...
3. **ICP refinement** — point-to-plane ICP (see
   [Week 10 §C1](10-zipline-aerial-perception-interview.md#c1-point-to-plane-icp-robust))
...
Full deep-dive in
[Week 10 §B3](10-zipline-aerial-perception-interview.md#b3-projecting-2d-semantics-into-the-3d-model-multi-view-label-fusion).
The points to hit:
...
(also summarized in
[Week 10 Part D](10-zipline-aerial-perception-interview.md#part-d--behavioral--system-design-framing)):
...
Full deep-dive in
[Week 10 §B4](10-zipline-aerial-perception-interview.md#b4-deliverability-confidence--building-and-calibrating-it).
Hit these:
...
Full deep-dive in
[Week 10 §B5](10-zipline-aerial-perception-interview.md#b5-coordinate-frames--getting-a-ground-point-into-the-aircraft-frame).
...
Full deep-dive in
[Week 10 §B6](10-zipline-aerial-perception-interview.md#b6-evaluation-when-there-is-no-3d-ground-truth).
...
[Week 10 Part C](10-zipline-aerial-perception-interview.md#part-c--solved-coding-problems):
