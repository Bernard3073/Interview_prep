...
> [Week 13 question bank](13-zipline-aerial-perception-interview.md). Read this as
> the "what would a strong senior/staff answer actually say" companion. Where a topic
> already has a deep-dive in Week 13 Part B, this links rather than repeats.
>
...
6. **Bundle adjustment** — jointly refine all poses + points by minimizing
   reprojection error (see [Week 13 §B1](13-zipline-aerial-perception-interview.md#b1-bundle-adjustment-with-a-pose-prior)).
...
Covered in full in
[Week 13 §B1](13-zipline-aerial-perception-interview.md#b1-bundle-adjustment-with-a-pose-prior).
...
Full deep-dive:
[Week 13 §B2](13-zipline-aerial-perception-interview.md#b2-dsm-vs-dtm--and-why-landing-cares).
Key points:
...
3. **ICP refinement** — point-to-plane ICP (see
   [Week 13 §C1](13-zipline-aerial-perception-interview.md#c1-point-to-plane-icp-robust))
...
Full deep-dive in
[Week 13 §B3](13-zipline-aerial-perception-interview.md#b3-projecting-2d-semantics-into-the-3d-model-multi-view-label-fusion).
The points to hit:
...
(also summarized in
[Week 13 Part D](13-zipline-aerial-perception-interview.md#part-d--behavioral--system-design-framing)):
...
Full deep-dive in
[Week 13 §B4](13-zipline-aerial-perception-interview.md#b4-deliverability-confidence--building-and-calibrating-it).
Hit these:
...
Full deep-dive in
[Week 13 §B5](13-zipline-aerial-perception-interview.md#b5-coordinate-frames--getting-a-ground-point-into-the-aircraft-frame).
...
Full deep-dive in
[Week 13 §B6](13-zipline-aerial-perception-interview.md#b6-evaluation-when-there-is-no-3d-ground-truth).
...
[Week 13 Part C](13-zipline-aerial-perception-interview.md#part-c--solved-coding-problems):
